      ...
      <div class="roleMessagebody">
        <div class="roleMessage-detail">
          ...
          <div class="roleMessage-rightdetail">
            <Input v-model="roleMessagedataToEdit.roleName" placeholder="请输入角色名称" clearable></Input>
          </div>
        </div>
        <div class="roleMessage-detail">
          <div class="roleMessage-leftdetail">角色编码：</div>
          <div class="roleMessage-rightdetail">
            <Input v-model="roleMessagedataToEdit.roleCode" placeholder="请输入角色编码" clearable></Input>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      * */
      roleMessageInsert() {
        this.isLoading = true;
        SystemService.EditRole(this.roleMessagedataToEdit).then(response => {
       ...
       * */
      usercheck() {
        if (this.roleMessagedataToEdit.roleName === '' || this.roleMessagedataToEdit.roleName === undefined) {
          this.sumitState = false;
          this.warnDisplay('请输入角色名称！');
        }
        else if (this.roleMessagedataToEdit.roleCode === '' || this.roleMessagedataToEdit.roleCode === undefined) {
          this.sumitState = false;
