...
//      this.goUrl('/websiteHome');
    ...
    methods: {
      ...
      goUrlNewClass(url, param, type) {
        ...
        this.$emit('watchSecondMenu', tempData);
      },
      goLogin() {
